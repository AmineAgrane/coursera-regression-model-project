...
```{r}
# PLEASE, REFERS TO GRAPPHIC FIGURE 3 AT APPENDIX
```
The Normal Q-Q plot (GRAPHIC FIGURE 3 AT APPENDIX) show that residuals are normally distributed (points close to line). Scale-Location plot shows a constant variance due to a constant band pattern.
